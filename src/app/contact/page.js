    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-64 bg-gradient-to-r from-teal to-deep-navy">
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <p className="text-xl opacity-90">{t("discussNeeds")}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-6xl px-4">
          <h2 className="text-3xl font-bold text-center text-deep-navy mb-12">{t("getInTouch")}</h2>
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-deep-navy mb-1">{t("address")}</h4>
                    <p className="text-gray-600">{t("factoryAddress")}</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-teal rounded-full flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h4 className="font-semibold text-deep-navy mb-1">{t("email")}</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-deep-navy mb-1">{t("phone")}</h4>
            ...
            {/* Maps Section */}
            <div className="mx-auto max-w-6xl px-4">
              <h2 className="text-3xl font-bold text-center text-deep-navy mb-12">{t("findUs")}</h2>
              <div className="bg-white p-8 rounded-lg shadow-md">
                <div className="aspect-video bg-gradient-to-br from-teal/20 to-deep-navy/20 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">{t("interactiveMapComingSoon")}</p>
                    <p className="text-sm text-gray-500 mt-2">{t("factoryAddress")}</p>
                  </div>
                </div>
              </div>
            </div>
